...
@section('title', 'Create Patient - Admin Dashboard')
    ...
    <div class="bg-gradient-to-r from-gold/10 to-gold-deep/10 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-text">Create New Patient</h1>
                    <p class="text-muted mt-2">Add a new patient to the system</p>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="emergency_contact" name="emergency_contact" rows="2"
                                          class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                          placeholder="Enter emergency contact information">{{ old('emergency_contact') }}</textarea>
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6">
            <div class="flex items-center space-x-3">
                ...
                <span class="text-gray-900 dark:text-white">Creating patient...</span>
            </div>
        </div>
    </div>
</div>
